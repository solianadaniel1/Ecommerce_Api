...
class ProductViewSetTest(APITestCase):
    def setUp(self):
        ...
        """
        # Create users
        self.user1 = get_user_model().objects.create_superuser(username='user1', email="user1@example.com", password='password123')
        self.user2 = get_user_model().objects.create_superuser(username='user2', email="user2@example.com", password='password123')
    ...
    def test_create_product(self):
        ...
        data = {
            ...
            'stock_quantity': 10,
            'description': 'tech',
            'categories': [self.category1.id]  # Assigning categories to the new product
        }
