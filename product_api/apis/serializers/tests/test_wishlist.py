...
class WishlistSerializerTest(APITestCase):
    def setUp(self):
        ...
        self.user = CustomUser.objects.create_user(email='test@example.com', password='testpassword', username="testuser")
        self.product = Product.objects.create(name='Test Product', stock_quantity=10, price=10.0)
    ...
    def test_readonly_fields(self):
        ...
        wishlist_item = serializer.save(user=self.user)  # Manually set the user in the save method
